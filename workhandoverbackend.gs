...
/*
   ...
   ADMIN:
   Show ALL active buildings.

   TECHNICIAN:
   Show ONLY buildings assigned to the
...
for (
  ...
  /*
     Ignore empty / inactive buildings.
  */

  if (!building || active !== "YES") {
  ...
  /*
     ...
     Admin can see every active building.
  */
  ...
  /*
     ...
     Technician can see only buildings assigned
     to that technician.
  */
...
/*
   -------------------------------------------------------
   GET ORIGINAL TECHNICIAN
   -------------------------------------------------------

   ADMIN:
   Get the actual technician assigned to
   the selected building.

   TECHNICIAN:
   Verify that the selected building belongs
...
/* =========================================================
   GET TECHNICIAN ASSIGNED TO BUILDING
========================================================= */

function getBuildingAssignedTechnician(
  token,
  buildingName
) {
  ...
  if (data.length <= 1) {
    ...
    throw new Error(
      "No building assignment data found."
    );
  ...
  */
  ...
  for (
    ...
    if (
      ...
      /*
         Get technician details from Users sheet.
      */
      ...
      const userHeaders =
        usersData[0].map(function(header) {
      ...
      const nameIndex =
        userHeaders.indexOf("Name");


      const emailIndex =
        userHeaders.indexOf("Email");


      const mobileIndex =
        userHeaders.indexOf("Mobile");


      const roleIndex =
        userHeaders.indexOf("Role");


      const statusIndex =
        userHeaders.indexOf("Status");
      ...
      for (
        ...
        if (
          ...
          if (
            ...
            throw new Error(
              "The technician assigned to this building is not active."
            );
      ...
      throw new Error(
        "Assigned technician was not found in Users sheet."
      );
  ...
  throw new Error(
    "No active technician is assigned to this building."
  );
